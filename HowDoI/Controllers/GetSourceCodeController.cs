...
namespace CSharp_HowDoISamples.Controllers
{
    public class GetSourceCodeController : Controller
    {
        ...
        private const string endTemplate = "</pre></div><link type='text/css' rel='stylesheet' href='http://{0}Scripts/SyntaxHighlighter/SyntaxHighlighter.css'></link><script language='javascript' src='http://{0}Scripts/SyntaxHighlighter/shCore.js'></script><script language='javascript' src='http://{0}Scripts/SyntaxHighlighter/shBrushCSharp.js'></script><script language='javascript' src='http://{0}Scripts/SyntaxHighlighter/shBrushXml.js'></script><script language='javascript'>";
        ...
        public string Razor()
        {
            ...
            string end = string.Format(CultureInfo.InvariantCulture, endTemplate, (Url.RequestContext.HttpContext).Request.Url.Authority + "/");
